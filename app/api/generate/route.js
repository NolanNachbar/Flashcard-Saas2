...
export async function POST(req) {
  try {
    ...
    const systemPrompt = `Generate ultra pithy flashcards based on the following topic: ${prompt}. Format the response as a list of flashcards with 'front' and 'back' properties. Each flashcard should have a 
...
presented in a way that facilitates learning and retention. Avoid creating overly wordy flashcards. 
